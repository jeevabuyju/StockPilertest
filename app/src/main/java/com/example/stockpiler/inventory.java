...
public class inventory extends AppCompatActivity {
    ...
    public static final String id = "com.example.stockpiler.DATA";
    ...
    public void selected(String data) {
        final Intent intent = new Intent(getApplicationContext(), inventoryInfo.class);
